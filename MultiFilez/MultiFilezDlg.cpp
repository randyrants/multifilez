...
BOOL CMultiFilezDlg::OnInitDialog()
{
	...
	m_dlgSplash.SetWindowPos(&wndTopMost, 0, 0, 0, 0, SWP_NOMOVE|SWP_NOSIZE);
...
BOOL CMultiFilezDlg::OnHelpInfo(HELPINFO* pHelpInfo) 
{
	OnHelp();
...
void CMultiFilezDlg::OnHelp() 
{
	ShellExecute(m_hWnd, "open", "help.htm", NULL, NULL, SW_SHOWNORMAL);
}
